<template>
  <div class="career-page">
    ...
    <div class="container">
      ...
      <div class="row flex-row-reverse career-item">
        <div class="col-12 col-lg-6 career__image">
          <img :src="careerInfo.section_img" alt="" />
        </div>

        <div class="col-12 col-lg-5 career__info">
          <h3 class="career__title">
            {{ careerInfo.section_title }}
          </h3>
...
export default {
  async setup() {
    ...
    const careerInfo = await findOne("career", {
      populate: {
        banner_img: "*",
        section_img: "*",
      },
    ...
    return {
      careerInfo: {
        ...careerInfo.data.attributes,
        banner_img: `${media}${careerInfo?.data?.attributes?.banner_img?.data?.attributes.url}`,
        section_img: `${media}${careerInfo?.data?.attributes?.section_img?.data?.attributes.url}`,
      },
    };
  },
};
